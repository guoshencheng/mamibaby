...
exports.fillPrompt = exports.STEP3_USER_PROMPT = exports.STEP3_SYSTEM_PROMPT = exports.STEP2_USER_PROMPT = exports.STEP2_SYSTEM_PROMPT = exports.STEP1_USER_PROMPT = exports.STEP1_SYSTEM_PROMPT = void 0;
// ============================================================================
// 第一步：生成故事概要
// ============================================================================
exports.STEP1_SYSTEM_PROMPT = `你是一位专业的儿童绘本故事创作专家。你擅长根据用户的提示创作富有想象力、教育意义和趣味性的绘本故事。
...
exports.STEP1_USER_PROMPT = `请根据以下提示创作一个绘本故事概要：
...
// ============================================================================
exports.STEP2_SYSTEM_PROMPT = `你是一位专业的绘本设计师和故事板艺术家。你需要根据故事概要，提取和设计故事中的核心元素，为后续的绘本插画创作做准备。
...
exports.STEP2_USER_PROMPT = `请根据以下故事概要，生成核心元素：
...
// 第三步：生成分镜详情
// ============================================================================
exports.STEP3_SYSTEM_PROMPT = `你是一位专业的绘本插画指导专家。你需要根据分镜概要以及之前定义的人物、物品、场景特征，为每个分镜生成详细的绘画指导说明。
...
exports.STEP3_USER_PROMPT = `请根据以下信息，为每个分镜生成详细的绘画指导说明：
...
// 工具函数：替换提示词中的占位符
// ============================================================================
const fillPrompt = (template, variables) => {
    let result = template;
...
//# sourceMappingURL=storyPrompts.js.map