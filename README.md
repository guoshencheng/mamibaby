...
基于 Vite + React 18 + TypeScript + Ant Design + Vercel AI SDK 的 AI 驱动绘本故事生成系统。
...
- **前端框架**: React 18.x
- **编程语言**: TypeScript 5.x
- **UI 组件库**: Ant Design 5.x + Ant Design X 1.x
...
4. **第二步**：点击"下一步"，发送任意消息触发核心元素生成
5. **第三步**：点击"下一步"，发送任意消息触发分镜详情生成
6. **查看结果**：右侧卡片实时展示所有生成的数据
